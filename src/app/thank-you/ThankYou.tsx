  ...
  if (data === false) {
    return (
      <div className="mt-24 flex w-full justify-center">
        <div className="flex flex-col items-center gap-2">
          <Loader2 className="h-8 w-8 animate-spin text-zinc-500" />
          <h3 className="text-xl font-semibold">Veryfying your payment...</h3>
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <p className="mt-2 text-base text-zinc-500">
            We&apos;ve recivde your order and are now processing it.{" "}
          </p>
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-900">
              ...
              quality, we replace it for free.
            </p>
          </div>
        </div>
              ...
              <div className="mt-2 text-zinc-700">
                <address className="not-italic">
                  ...
                  <span className="block">
                    {ShippingAdress?.postalCode} {ShippingAdress?.city}
                  </span>
                </address>
              </div>
            </div>
        ...
        <div className="spase-y-6 border-t border-zinc-200 pt-10 text-sm">
